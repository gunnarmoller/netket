...
#ifndef NETKET_ABSTRACTSAMPLERDM_HPP
#define NETKET_ABSTRACTSAMPLERDM_HPP
...
class AbstractSamplerDM {
 public:
  ...
  virtual AbstractDensityMatrix::VectorType DerLogVisible() {
    return GetMachine().DerLog(Visible());
  }

  virtual ~AbstractSamplerDM() {}
  ...
  AbstractDensityMatrix& GetMachine() const noexcept { return psi_; }
 ...
 protected:
  AbstractSamplerDM(AbstractDensityMatrix& psi)
