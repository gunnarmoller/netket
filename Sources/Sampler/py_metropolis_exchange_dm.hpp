...
#ifndef NETKET_PY_METROPOLISEXCHANGEDM_HPP
#define NETKET_PY_METROPOLISEXCHANGEDM_HPP

#include <pybind11/pybind11.h>
#include "metropolis_exchange_dm.hpp"
...
void AddMetropolisExchangeDM(py::module &subm) {
  py::class_<MetropolisExchangeDM, AbstractSamplerDM>(subm, "MetropolisExchangeDM",
    ...
    otherwise the sampling would be strongly not ergodic.
      ...
      .def(py::init<const AbstractGraph &, AbstractDensityMatrix &, int>(),
