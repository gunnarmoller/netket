...
#ifndef NETKET_METROPOLISEXCHANGEDM_HPP
#define NETKET_METROPOLISEXCHANGEDM_HPP
...
class MetropolisExchangeDM : public AbstractSamplerDM {
  ...
  // Look-up tables
  typename AbstractDensityMatrix::LookupType lt_;
 ...
 public:
  ...
  AbstractDensityMatrix::VectorType DerLogVisible() override {
